...
class DenseNet():
    def __init__(self, x, nb_blocks, filters, training, model_type=None):
    ...
    def Dense_net(self, input_x):
        ...
        #block_order = [6, 12, 48, 32]
        if self.model_type == "nb_layer_121":
            block_order = nb_layers_121
        elif self.model_type == "nb_layer_169":
            block_order = nb_layers_169
        elif self.model_type == "nb_layer_201":
            block_order = nb_layers_201
        elif self.model_type == "nb_layer_264":
            block_order = nb_layers_264
        else:
            block_order = nb_layers_169
